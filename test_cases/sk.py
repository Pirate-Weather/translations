...
cases = {
    ...
    "Dym": ["title", "smoke"],
    "Počas dňa dym.": ["sentence", ["for-day", "smoke"]],
    "Ráno dym.": ["sentence", ["during", "smoke", "morning"]],
    "Dym až do dnešného večera.": ["sentence", ["until", "smoke", "today-evening"]],
    "Dym a čiastočne zamračené": ["title", ["and", "smoke", "light-clouds"]],
    "Opar": ["title", "haze"],
    "Počas dňa opar.": ["sentence", ["for-day", "haze"]],
    "Popoludní opar.": ["sentence", ["during", "haze", "afternoon"]],
    "Opar a vysoká vlhkosť": ["title", ["and", "haze", "high-humidity"]],
    "Hmla": ["title", "mist"],
