...
cases = {
    ...
    "Mwg": ['title', 'smoke'],
    "Mwg drwy’r dydd.": ['sentence', ['for-day', 'smoke']],
    "Mwg yn y bore.": ['sentence', ['during', 'smoke', 'morning']],
    "Mwg hyd at gyda’r hwyr heno.": ['sentence', ['until', 'smoke', 'today-evening']],
    "Mwg a rhannol gymylog": ['title', ['and', 'smoke', 'light-clouds']],
    "Niwl": ['title', 'haze'],
    "Niwl drwy’r dydd.": ['sentence', ['for-day', 'haze']],
    "Niwl yn y prynhawn.": ['sentence', ['during', 'haze', 'afternoon']],
    "Niwl a chlòs": ['title', ['and', 'haze', 'high-humidity']],
    "Llwch": ['title', 'mist'],
