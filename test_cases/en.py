...
cases = {
    ...
    "Freezing Fog": ["title", "freezing-fog"],
    "Snow Grains": ["title", "snow-grains"],
    "Light Rainshower": ["title", "light-rain-shower"],
    "Rainshower": ["title", "rain-shower"],
    "Heavy Rainshower": ["title", "heavy-rain-shower"],
    "Light Snowshower": ["title", "light-snow-shower"],
    "Snowshower": ["title", "snow-shower"],
    "Heavy Snowshower": ["title", "heavy-snow-shower"],
    "Thunderstorm with Hail": ["title", "thunderstorm-with-hail"],
