...
cases = {
    ...
    "Дим": ["title", "smoke"],
    "Дим протягом всього дня.": ["sentence", ["for-day", "smoke"]],
    "Дим вранці.": ["sentence", ["during", "smoke", "morning"]],
    "Дим до сьогоднішнього вечору.": ["sentence", ["until", "smoke", "today-evening"]],
    "Дим і Невелика Хмарність": ["title", ["and", "smoke", "light-clouds"]],
    "Імла": ["title", "haze"],
    "Імла протягом всього дня.": ["sentence", ["for-day", "haze"]],
    "Імла вдень.": ["sentence", ["during", "haze", "afternoon"]],
    "Імла і Волого": ["title", ["and", "haze", "high-humidity"]],
    "Туман": ["title", "mist"],
