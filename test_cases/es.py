...
cases = {
    ...
    "Humo": ['title', 'smoke'],
    "Humo durante el día.": ['sentence', ['for-day', 'smoke']],
    "Humo por la mañana.": ['sentence', ['during', 'smoke', 'morning']],
    "Humo hasta esta noche.": ['sentence', ['until', 'smoke', 'today-evening']],
    "Humo y Parcialmente Nublado": ['title', ['and', 'smoke', 'light-clouds']],
    "Calima": ['title', 'haze'],
    "Calima durante el día.": ['sentence', ['for-day', 'haze']],
    "Calima por la tarde.": ['sentence', ['during', 'haze', 'afternoon']],
    "Calima y Húmedo": ['title', ['and', 'haze', 'high-humidity']],
    "Bruma": ['title', 'mist'],
