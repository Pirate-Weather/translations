...
cases = {
    ...
    "धुआँ": ['title', 'smoke'],
    "सारे दिन धुआँ": ['sentence', ['for-day', 'smoke']],
    "धुआँ सुबह के दौरान": ['sentence', ['during', 'smoke', 'morning']],
    "धुआँ इस शाम तक": ['sentence', ['until', 'smoke', 'today-evening']],
    "धुआँ और सामान्य बादल": ['title', ['and', 'smoke', 'light-clouds']],
    "धुंध": ['title', 'mist'],
    "सारे दिन धुंध": ['sentence', ['for-day', 'mist']],
    "धुंध दोपहर के दौरान": ['sentence', ['during', 'haze', 'afternoon']],
