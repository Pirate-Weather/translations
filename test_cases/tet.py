...
cases = {
    ...
    "Ahi-Suar": ["title", "smoke"],
    "Ahi-suar loron tomak.": ["sentence", ["for-day", "smoke"]],
    "Ahi-suar iha dader.": ["sentence", ["during", "smoke", "morning"]],
    "Ahi-suar to ohin kalan.": ["sentence", ["until", "smoke", "today-evening"]],
    "Ahi-Suar Ho Abu-Abu Uituan": ["title", ["and", "smoke", "light-clouds"]],
    "Rai-Rahun": ["title", "haze"],
    "Rai-rahun loron tomak.": ["sentence", ["for-day", "haze"]],
    "Rai-rahun lokraik.": ["sentence", ["during", "haze", "afternoon"]],
    "Rai-Rahun Ho Bokon": ["title", ["and", "haze", "high-humidity"]],
    "Kalohan": ["title", "mist"],
