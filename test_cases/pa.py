...
cases = {
    ...
    "ਧੂੰਆਂ": ['title', 'smoke'],
    "ਧੂੰਆਂ ਪੂਰਾ ਦਿਨ": ['sentence', ['for-day', 'smoke']],
    "ਧੂੰਆਂ ਸਵੇਰ ਦੇ ਦੌਰਾਨ": ['sentence', ['during', 'smoke', 'morning']],
    "ਧੂੰਆਂ ਅੱਜ ਸ਼ਾਮ ਤਕ": ['sentence', ['until', 'smoke', 'today-evening']],
    "ਧੂੰਆਂ ਹੋਰ ਕੁਝ ਹੱਦ ਤਕ ਬੱਦਲ ਹੋਣਾ": ['title', ['and', 'smoke', 'light-clouds']],
    "ਧੁੰਦ": ['title', 'mist'],
    "ਧੁੰਦ ਪੂਰਾ ਦਿਨ": ['sentence', ['for-day', 'mist']],
    "ਧੁੰਦ ਦੋਪਹਰ ਦੇ ਦੌਰਾਨ": ['sentence', ['during', 'haze', 'afternoon']],
    "ਧੁੰਦ ਹੋਰ ਨਮੀ": ['title', ['and', 'haze', 'high-humidity']],
    "ਧੁੰਦ ਰਾਤ ਭਰ ਦੇ ਦੌਰਾਨ": ['sentence', ['during', 'mist', 'night']],
    "ਧੁੰਦ ਹੋਰ ਘਣੇ ਬੱਦਲ": ['title', ['and', 'mist', 'heavy-clouds']],
}
