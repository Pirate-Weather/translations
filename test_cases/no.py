...
cases = {
    ...
    "Røyk": ['title', 'smoke'],
    "Røyk i løpet av dagen.": ['sentence', ['for-day', 'smoke']],
    "Røyk om morgenen.": ['sentence', ['during', 'smoke', 'morning']],
    "Røyk fram til i løpet av kvelden.": ['sentence', ['until', 'smoke', 'today-evening']],
    "Røyk og lettskyet": ['title', ['and', 'smoke', 'light-clouds']],
    "Dis": ['title', 'haze'],
    "Dis i løpet av dagen.": ['sentence', ['for-day', 'haze']],
    "Dis på ettermiddagen.": ['sentence', ['during', 'haze', 'afternoon']],
    "Dis og fuktig": ['title', ['and', 'haze', 'high-humidity']],
