...
cases = {
    ...
    "Mog": ["title", "smoke"],
    "Mog dres oll an jydh.": ["sentence", ["for-day", "smoke"]],
    "Mog y'n myttin.": ["sentence", ["during", "smoke", "morning"]],
    "Mog bys yn haneth.": ["sentence", ["until", "smoke", "today-evening"]],
    "Mog Ha Nebes Komolek": ["title", ["and", "smoke", "light-clouds"]],
    "Kemygi": ["title", "haze"],
    "Kemygi dres oll an jydh.": ["sentence", ["for-day", "haze"]],
    "Kemygi y'n dohajydh.": ["sentence", ["during", "haze", "afternoon"]],
    "Kemygi Ha Glyb": ["title", ["and", "haze", "high-humidity"]],
    "Niwl": ["title", "mist"],
