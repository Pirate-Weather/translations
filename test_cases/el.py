...
cases = {
    ...
    "Ομίχλη": ["title", "fog"],
    "Κυρίως αίθριος": ["title", "very-light-clouds"],
    ...
    "Καπνός": ["title", "smoke"],
    "Καπνός κατά τη διάρκεια της ημέρας.": ["sentence", ["for-day", "smoke"]],
    "Καπνός το πρωί.": ["sentence", ["during", "smoke", "morning"]],
    "Καπνός μέχρι το απόγευμα.": ["sentence", ["until", "smoke", "today-evening"]],
    "Καπνός και αραιή νέφωση": ["title", ["and", "smoke", "light-clouds"]],
    "Eλαφριά ομίχλη": ["title", "haze"],
    "Eλαφριά ομίχλη κατά τη διάρκεια της ημέρας.": ["sentence", ["for-day", "haze"]],
    "Eλαφριά ομίχλη το μεσημέρι.": ["sentence", ["during", "haze", "afternoon"]],
    "Eλαφριά ομίχλη και υγρασία": ["title", ["and", "haze", "high-humidity"]],
    "Ομίχλη κατά τη διάρκεια της ημέρας.": ["sentence", ["for-day", "mist"]],
    "Ομίχλη το βράδυ.": ["sentence", ["during", "mist", "night"]],
    "Ομίχλη και συννεφιά": ["title", ["and", "mist", "heavy-clouds"]],
}
