...
cases = {
    ...
    "Καπνιά": ["title", "haze"],
    "Καπνιά κατά τη διάρκεια της ημέρας.": ["sentence", ["for-day", "haze"]],
    "Καπνιά το μεσημέρι.": ["sentence", ["during", "haze", "afternoon"]],
    "Καπνιά και υγρασία": ["title", ["and", "haze", "high-humidity"]],
