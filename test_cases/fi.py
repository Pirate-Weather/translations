...
cases = {
    ...
    "Savu": ["title", "smoke"],
    "Savu päivän aikana.": ["sentence", ["for-day", "smoke"]],
    "Savu aamulla.": ["sentence", ["during", "smoke", "morning"]],
    "Savu iltaan asti.": ["sentence", ["until", "smoke", "today-evening"]],
    "Savu ja puolipilvistä": ["title", ["and", "smoke", "light-clouds"]],
    "Huntu": ["title", "haze"],
    "Huntu päivän aikana.": ["sentence", ["for-day", "haze"]],
    "Huntu iltapäivällä.": ["sentence", ["during", "haze", "afternoon"]],
    "Huntu ja kosteaa": ["title", ["and", "haze", "high-humidity"]],
    "Sumu": ["title", "mist"],
