...
cases = {
    ...
    "Dūmi": ['title', 'smoke'],
    "Visu dienu dūmi.": ['sentence', ['for-day', 'smoke']],
    "No rīta dūmi.": ['sentence', ['during', 'smoke', 'morning']],
    "Dūmi līdz vakaram.": ['sentence', ['until', 'smoke', 'today-evening']],
    "Dūmi un daļēji mākoņains": ['title', ['and', 'smoke', 'light-clouds']],
    "Dūmaka": ['title', 'haze'],
    "Visu dienu dūmaka.": ['sentence', ['for-day', 'haze']],
    "Pēcpusdienā dūmaka.": ['sentence', ['during', 'haze', 'afternoon']],
    "Dūmaka un mitrs": ['title', ['and', 'haze', 'high-humidity']],
