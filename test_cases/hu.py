...
cases = {
    ...
    "Füst": ["title", "smoke"],
    "Füst egész nap.": ["sentence", ["for-day", "smoke"]],
    "Füst reggel.": ["sentence", ["during", "smoke", "morning"]],
    "Füst ma este.": ["sentence", ["until", "smoke", "today-evening"]],
    "Füst és közepes felhősödés": ["title", ["and", "smoke", "light-clouds"]],
    "Pára": ["title", "haze"],
    "Pára egész nap.": ["sentence", ["for-day", "haze"]],
    "Pára délután.": ["sentence", ["during", "haze", "afternoon"]],
    "Pára és párás idő": ["title", ["and", "haze", "high-humidity"]],
    "Köd": ["title", "mist"],
