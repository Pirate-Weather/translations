...
cases = {
    ...
    "Fumée": ["title", "smoke"],
    "Fumée toute la journée.": ["sentence", ["for-day", "smoke"]],
    "Fumée dans la matinée.": ["sentence", ["during", "smoke", "morning"]],
    "Fumée jusqu’à ce soir.": ["sentence", ["until", "smoke", "today-evening"]],
    "Fumée et Faibles Passages Nuageux": ["title", ["and", "smoke", "light-clouds"]],
    "Brume": ["title", "mist"],
    "Brume toute la journée.": ["sentence", ["for-day", "mist"]],
    "Brume dans l’après-midi.": ["sentence", ["during", "haze", "afternoon"]],
    "Brume et Temps Humide": ["title", ["and", "haze", "high-humidity"]],
    "Brume dans la nuit.": ["sentence", ["during", "mist", "night"]],
    "Brume et Ciel Couvert": ["title", ["and", "mist", "heavy-clouds"]],
}
