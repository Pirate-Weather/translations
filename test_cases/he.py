...
cases = {
    ...
    "עשן": ['title', 'smoke'],
    "עשן לאורך היום.": ['sentence', ['for-day', 'smoke']],
    "עשן בבוקר.": ['sentence', ['during', 'smoke', 'morning']],
    "עשן עד הערב.": ['sentence', ['until', 'smoke', 'today-evening']],
    "עשן ועננות חלקית": ['title', ['and', 'smoke', 'light-clouds']],
    "אובך": ['title', 'haze'],
    "אובך לאורך היום.": ['sentence', ['for-day', 'haze']],
    "אובך אחר הצהרים.": ['sentence', ['during', 'haze', 'afternoon']],
    "אובך ולחות גבוהה": ['title', ['and', 'haze', 'high-humidity']],
