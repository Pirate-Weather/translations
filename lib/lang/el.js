...
function singular_or_plural(n,singular,plural){
  return Math.abs(parseInt(n)) === 1 ? singular : plural;
}
...
module.exports = {
  ...
  "possible-freezing-drizzle": "πιθανή παγερό ψιλόβροχο",
  "freezing-drizzle": "παγερό ψιλόβροχο",
  "possible-light-freezing-rain": "πιθανή ελαφριά παγωμένη βροχή",
  "light-freezing-rain": "ελαφριά παγωμένη βροχή",
  "possible-freezing-rain": "πιθανή παγωμένη βροχή",
  "freezing-rain": "freezing βροχή",
  ...
  "starting-continuing-until": function(condition, a, b) {
    return condition + " που θα αρχίσει " + a + ", και θα συνεχιστεί μέχρι " + strip_prefix(b);
  },
  "during": "$1 $2",
  "for-week": "$1 κατά τη διάρκεια της εβδομάδας",
  "over-weekend": "$1 το Σαββατοκύριακο",
  "temperatures-peaking": function(temperature,day){
    const sop = singular_or_plural(temperature,"στον","στους");
    return `τη θερμοκρασία να κορυφώνεται ${sop} ${temperature} ${day}`;
  },
  "temperatures-rising": function(temperature,day){
    const sop = singular_or_plural(temperature,"τον","τους");
    return `τη θερμοκρασία να αυξάνεται έως ${sop} ${temperature} ${day}`;
  },
  "temperatures-valleying": function(temperature,day){
    const sop = singular_or_plural(temperature,"στον","στους");
    return `τη θερμοκρασία να πέφτει ${sop} ${temperature} ${day}`;
  },
  "temperatures-falling": function(temperature,day){
    const sop = singular_or_plural(temperature,"στον","στους");
    return `τη θερμοκρασία να μειώνεται ${sop} ${temperature} ${day}`;
  },
