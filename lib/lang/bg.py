...
template = {
    ...
    "possible-freezing-drizzle": "възможна замразяване ръмеж",
    "freezing-drizzle": "freezing ръмеж",
    "possible-light-freezing-rain": "възможна слаб замразяване дъжд",
    "light-freezing-rain": "слаб замразяване дъжд",
    "possible-freezing-rain": "възможна замразяване дъжд",
    "freezing-rain": "замразяване дъжд",
