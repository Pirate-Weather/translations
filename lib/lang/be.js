...
module.exports = {
  ...
  "possible-freezing-drizzle": "магчымы замарожванне нязначны дождж",
  "freezing-drizzle": "freezing нязначны дождж",
  "possible-light-freezing-rain": "магчымы невялікі замарожванне дождж",
  "light-freezing-rain": "light замарожванне дождж",
  "possible-freezing-rain": "магчымы замарожванне дождж",
  "freezing-rain": "freezing дождж",
  "possible-heavy-freezing-rain": "магчымы моцны замарожванне дождж",
  "heavy-freezing-rain": "heavy замарожванне дождж",
