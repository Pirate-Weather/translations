...
module.exports = {
  ...
  "possible-freezing-drizzle": "טפטוף מקפיא אפשרי",
  "freezing-drizzle": "טפטוף מקפיא",
  "possible-light-freezing-rain": "גשם קל וקפוא אפשרי",
  "light-freezing-rain": "גשם קפוא קל",
  "possible-freezing-rain": "גשם קופא אפשרי",
  ...
  // Since Hebrew has no capitalization, simply return the original string
  "title": function(str) {
    return str;
  },
