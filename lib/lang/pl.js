...
module.exports = {
  ...
  "and": function(a, b) {
    const times = ["w poniedziałek","we wtorek","w środę","w czwartek","w piątek",
  ...
  "until": function(condition, period) {
    const lstr = (condition.indexOf("opady") > -1) ? ", ustaną " : ", ustanie ";
  ...
  "starting-continuing-until": function(condition, a, b) {
    const lstr = (condition.indexOf("opady") > -1) ? ", skończą" : ", skończy";
