...
function strip_prefix(period) {
  if(period.slice(0, 10) === "om natten") {
...
module.exports = {
  ...
  "possible-freezing-drizzle": "mulighed for frysende støvregn",
  "freezing-drizzle": "frysende støvregn",
  "possible-light-freezing-rain": "mulighed for let frysende regn",
  "light-freezing-rain": "let frysende regn",
  "possible-freezing-rain": "mulighed for frysende regn",
  "freezing-rain": "freezing regn",
