...
def test_recursively_apply_function_templates(test_translation):
    assert test_translation.translate(["bar", 10, ["baz", 20, "foo"]]) == "meeple meeple bar"
...
def test_provide_context_to_functions():
    ...
    assert test.translate(["foo", "bar", ["baz", "quux"], ["neem", ["glorp", 42]]]) == "Moop. Boop. Soup. Floop. Bloop. Rope?"
