...
template = {
    ...
    "possible-medium-precipitation": "posible precipitación",
    "possible-heavy-precipitation": "posible fuerte precipitación",
    "possible-medium-rain": "posible lluvia",
    "possible-heavy-rain": "posible fuertes lluvias",
