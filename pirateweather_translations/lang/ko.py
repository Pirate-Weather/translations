def join_with_shared_prefix(a, b, joiner):
    ...
    # Compare characters until the shared prefix is found
    while i < len(a) and i < len(b) and ord(a[i]) == ord(b[i]):
        i += 1

    # Move i back to the last space (if there is one)
    while i > 0 and ord(a[i - 1]) != 32:
        i -= 1

    # Combine the strings with the shared prefix and joiner
...
template = {
    ...
    "thunderstorm": "뇌우",
    "possible-medium-precipitation": "강수 가능성",
    "possible-heavy-precipitation": "강한 강수 가능성",
    "possible-medium-rain": "비 가능성",
    "possible-heavy-rain": "강한 비 가능성",
    "possible-medium-sleet": "진눈깨비 가능성",
    "possible-heavy-sleet": "강한 진눈깨비 가능성",
    "possible-medium-snow": "눈 가능성",
    "possible-heavy-snow": "강한 눈 가능성",
    "possible-very-light-freezing-rain": "얼어붙는 이슬비 가능성",
    "very-light-freezing-rain": "얼어붙는 이슬비",
    "possible-light-freezing-rain": "약한 얼어붙는 비 가능성",
    "light-freezing-rain": "약한 얼어붙는 비",
    "possible-medium-freezing-rain": "얼어붙는 비 가능성",
    "medium-freezing-rain": "얼어붙는 비",
    "possible-heavy-freezing-rain": "강한 얼어붙는 비 가능성",
    "heavy-freezing-rain": "강한 얼어붙는 비 가능성",
    "possible-hail": "빗발 가능성",
    "hail": "빗발",
    "light-wind": "약한 바람",
    "medium-wind": "바람",
    "heavy-wind": "강한 바람",
