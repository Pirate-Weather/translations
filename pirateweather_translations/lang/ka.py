...
template = {
    ...
    "next-hour-forecast-status": "მომდევნო საათის პროგნოზებია $1 გამო $2",
    "unavailable": "მიუწვდომელია",
    "temporarily-unavailable": "დროებით მიუწვდომელია",
    "partially-unavailable": "ნაწილობრივ მიუწვდომელია",
    "station-offline": "ყველა ახლომდებარე რადარის სადგური გამორთულია",
    "station-incomplete": "ახლომდებარე რადარის სადგურებიდან დაფარვის ხარვეზები",
    "smoke": "კვამლი",
    "haze": "ბურუსი",
    "mist": "ნისლი",
}
